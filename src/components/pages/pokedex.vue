...
<template>
  <div class="pokedex-scroll" ref="scrollContainer">
    <div class="pokedex-grid">
      <Pokecard v-for="p in visiblePokemons" :key="p.id" :id="p.id" :name="p.name" :src="p.image"
  ...
  <aside class="mdc-drawer mdc-drawer--modal pokemon-sheet">
    <div class="mdc-drawer__content">
      ...
      <div class="tab-content">
        <PokeDetail v-if="activeTab === 'pokemon' && selectedPokemonId" :id="selectedPokemonId" @close="closeDetail" />
        <div v-else-if="activeTab === 'evolutions'" class="evolutions-placeholder">
          <EvolutionChain :id="selectedPokemonId" @close="closeDetail"/>
        </div>
      </div>
